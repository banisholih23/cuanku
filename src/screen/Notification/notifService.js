...
export default class NotifService {
  ...
  createDefaultChannels() {
    PushNotification.createChannel(
      ...
      (created) => console.log(`createChannel 'default-channel-id' returned '${created}'`) // (optional) callback returns whether the channe
    );
    PushNotification.createChannel(
      {
      ...
      (created) => console.log(`createChannel 'sound-channel-id' returned '${created}'`) // (optional) callback returns whether the channel
    );
  }
